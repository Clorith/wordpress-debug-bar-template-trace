...
class Debug_Bar_Template_Trace extends Debug_Bar_Panel {
    ...
    function add_admin_notice() {
        ...
        if ( current_user_can( 'administrator' )
            ...
            printf(__('The file wp-includes/template.php is not writeable. You will need to manually edit it to use WP Debug Bar Template Trace. Add this line in the load_template() function, in wp-includes/template.php around line 405:<BR>
